...
*AUFGABE 1a
 Peg_max_red        Zulässiges Stauziel von Novmeber bis April                          /1762/
 E_red              Reduzierter Energieinhalt von November bis April
...
*AUFGABE 1a
E_red = 9.81/3.6*sum(k,Koeff(k)*(Peg_max_red-Peg_min)**ord(k));
...
*AUFGABE 1a
 e_Energie_limit(t) .. v_EnInh(t)$((ord(t)>=745) and (ord(t)<=5088))=l= E_red;
