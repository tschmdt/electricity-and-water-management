...
*AUFGABE 1c
 v_P_Pump(t)         1.c) Pumpleistung in MW
;
...
*AUFGABE 1c
 e_Pumpleistung(t)      1.c) Pumpleistung
;

*AUFGABE 1c
 e_Erloes .. v_Erloes =e= sum(t,(p_Preis(t)-16)*v_P_Turb(t)-(p_Preis(t)+3.2)*v_P_Pump(t));
* e_Energieinhalt(t) .. v_EnInh(t) - v_EnInh(t--1) =e= 0.8*9.81/1000*Dar(t)*v_Fallhoehe(t)+(0.2*9.81/1000*Dar(t)*(1597-H_Bezug))-v_P_Turb(t)/etaTurb;
 e_Pumpleistung(t) .. v_P_Pump(t) =e= 0.2*9.81/1000*Dar(t)*(v_Fallhoehe(t)+H_Bezug-1597)/0.8;
