...
#Aufgabe 1b Kraftwerksleistung

#Aufgabe 1c Dargebot
eta_pump_dar        Wirkungsgrad der Pumpe für die Dargebotsförderung                   /0.8/
Netzkosten_pump_dar Systemnutzungsentgeld in [Euro pro MWh]                             /3.2/
Peg_dar             Höhe des Darbegots in m                                             /1597/
...
Positive Variables
 ...
 v_Fallhoehe(t)
 #Aufgabe 1c
 v_Pump_dar(t)      elektrische Pumpleistung für das unten gelegene Dargebot in [MW]
;
...
#Aufgabe 1a Absenkung Stauziel
v_EnInh.up(t)$(ord(t)>=4 and (ord(t)<=5088)) = E_max_winter;

#Anzeige der maximalen Energieinhalte
display E_max;
...
Equations
 ...
 e_Fallhoehe(t)
 e_Turbinieren(t)
#Zweite Lösung Aufgabe 1a
# e_Energieinhalt_winter(t)
#Aufgabe 1b
 e_Turb_abfall(t)   Gibt maximalen Abfall der Pumpleistung (-200MW) an
 #e_Turb_aus(t)      Bedingung das Kraftwerk abschalten darf (muss 100MW im vorherigen t sein)
#Aufgabe 1c
 e_Pump_dar(t)
;

e_Erloes            .. v_Erloes =e= Sum(t, (p_Preis(t)-Netzkosten) * v_Turb(t) - (v_Pump_dar(t)*Netzkosten_pump_dar));
...
#Aufgabe 1b
e_Turb_abfall(t)    .. v_Turb(t) - v_Turb(t--1) =g= -200; #Leistunsabfall darf maximal 200MW sein
#e_Turb_aus(t)       .. v_Turb(t) =g= 0$(v_Turb(t--1) <= 100); #v_Turb darf 0 werden wenn v_Turb(t=-1) kleiner gleich 100 MW ist     

#Aufgabe 1c ändert nichts am Energieinhalt, vermindert 'nur' den Erlös
e_Pump_dar(t)  .. v_Pump_dar(t) =e= (Dar(t)*0.2 * 9.81 * 1000 * (v_Pegel(t)-Peg_dar))/(1000000*eta_pump_dar);
