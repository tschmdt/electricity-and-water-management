...
e_Angebotene_Leistung(t) .. v_Angebotene_Leistung(t) =e= v_P_Turb(t);
...
solve Aufgabenstellung using MIP maximize v_Erloes;

solve Aufgabenstellung using MIP minimize v_Angebotene_Leistung;
...
loop(t,put , v_Erloes.l:12:3, v_Angebotene_Leistung.l(t):12:3/);
