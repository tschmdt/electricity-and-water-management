...
$CALL  GDXXRW.EXE  20241213_Input-Output_LTHS.xlsx Par=p_Preis rng=Input!A3 Cdim=0 Rdim=1 Trace = 3
$GDXIN 20241213_Input-Output_LTHS
$LOAD  p_Preis
$GDXIN
display p_Preis;

Parameter  Dar(t)     Natürlicher Zufluss von t-1 bis t [m3 pro s];
$CALL   GDXXRW.EXE  20241213_Input-Output_LTHS.xlsx Par=Dar rng=Input!C3 Cdim=0 Rdim=1 Trace = 3
$GDXIN  20241213_Input-Output_LTHS
$LOAD   Dar
$GDXIN
display Dar;
...
Equations
 ...
 e_Energieinhalt(t) ..  v_EnInh(t)-v_EnInh(t--1)  =e= Dar(t)*v_Fallhöhe(t)*9.81/1000-v_P_Turb(t)/etaTurb;
 e_Fallhoehe(t)     ..  v_Fallhoehe(t) 
...
execute 'gdxxrw.exe  results2.gdx o=20241213_Input-Output_LTHS.xlsx squeeze=N Equ=e_Energieinhalt.M   rng=Output!B3 rdim=1 cdim=0'
execute 'gdxxrw.exe  results2.gdx o=20241213_Input-Output_LTHS.xlsx squeeze=N var=v_EnInh.L  rng=Output!A3 rdim=1 cdim=0'
