...
Equations
 g_Kosten                         Gesamterlös (Zielfunktion)
...
* Zielfunktion
 g_Kosten                    .. v_Kosten =e= sum(t,12*v_P_Turb(t)+(Preis(t)+20)*v_P_Pump(t));
...
g_Bilanz(t) .. p_Bilanz(t) =e=  v_P_Turb(t) - v_P_Pump(t)
 
model Aufgabenstellung /all/

* Wähle passenden Solver
Option MIP = CPLEX;
solve Aufgabenstellung using MIP minimizing v_Kosten;
...
file results3  /Aufgabe_5_Erweiterung.txt/;
*results3.pw = 1000;
put results3;
put't':20:0,'Spot':20:2,'Bilanz':20:00/
loop(t,put , ord(t):20:0, g_Bilanz.m(t):20:2,p_Bilanz(t):20:0 /);
