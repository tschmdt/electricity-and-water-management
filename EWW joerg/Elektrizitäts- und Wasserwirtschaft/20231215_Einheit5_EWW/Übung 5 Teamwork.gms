...
e_Betriebsinhalt(t)$(Ord(t)>1) .. v_Inh(t) - v_Inh(t-1) =e= (3600 / (10**6)) * (Dargebot - v_Q_Turb(t) + v_Q_Pump(t)); # hm^3 =  m^3 / s -> 10^6 m^3 = 3600 * m^3 / h * 1h
...
e_Max_Turbinendurchfluss(t) .. v_Q_Turb(t) =l= Q_max *  Turb_on(t);

e_Min_Turbinendurchfluss(t) .. v_Q_Turb(t) =g= Q_min *  Turb_on(t);

e_Turbinenmaschinensatz(t) .. Turb_on(t) =l= Anzahl_MS;

e_Maschinensatzbedingung(t) .. Sum(n,lambda(t,n)) =e= Turb_on(t);

*Pumpe:

e_Pumbenbetrieb_Durchfluss(t) .. v_Q_Pump(t) =e= Q_pump * Pump_on(t);
...
e_Pumpmaschinensatz(t) .. Pump_on(t) =l= Anzahl_MS;
