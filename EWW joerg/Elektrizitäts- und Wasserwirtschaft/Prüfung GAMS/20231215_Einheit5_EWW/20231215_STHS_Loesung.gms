...
Min_Pump = H*Q_min*9.81/1000*(Q_max/Q_max-0.095)/(0.18+0.63*(Q_max/Q_max-0.095)+0.31*(Q_max/Q_max-0.095)**2);
...
* Zielfunktion
 g_Erloes                     .. v_Erloes =e= sum(t,(Preis(t)-12)*v_P_Turb(t)-(Preis(t)+20)*v_P_Pump(t)-v_on_Akku(t)*Akkukosten);
