...
Scalars
 ...
 Peg_max_Lawine     Stauziel in den Monaten Nov bis April [m]                           /1762/
* E_max_Lawine
...
*E_max_Lawine = 9.81/3.6*sum(k,Koeff(k)*(Peg_max_Lawine-Peg_min)**ord(k));
...
e_Energieinhalt(t) .. v_EnInh(t) =e= v_EnInh(t--1) + ((Dar(t) * 9.81 * 1000 * v_Fallhoehe(t))/1000000)*1 - (v_Turb(t) / etaTurb)*1; #Mal 1 steht für mal 1 Stunde um auf MWh zu kommen
...
*e_EnergieinhaltLawine(t)$(Ord(t)>745 and Ord(t)<5088) ..  v_EnInh(t) =l= E_max_Lawine; #Prüfungsaufgabe 2021 1A

*e_Oeko1(t)$(v_Turb(t-1) = 400) .. v_Turb(t) =g= 200;

*e_Oeko2(t)$(v_Turb(t-1) = 100) .. v_Turb(t) =g= 0;

*e_Oeko3(t)$(v_Turb(t) > 100 and v_Turb(t) < 400) .. v_Turb(t+1) =g= v_Turb(t) + (-200-(-100))/(400-100) * (v_Turb(t+1)-v_Turb(t));
...
put Output;
put 'Stunde t:':20:20, 'Turbinenleistung':20:20/
loop(t,put , ord(t):20:0, v_Turb.l(t):20:2/);